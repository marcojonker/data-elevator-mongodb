...
var BaseLevelController = require('data-elevator/lib/controllers/level-controllers/base-level-controller');
...
var MongoDbLevelController = function(config) {
    ...
    if(!config.levelControllerConfig.connectionUrl || typeof config.levelControllerConfig.connectionUrl !== 'string' && config.mongoDbLevelControllerConfig.connectionUrl.length === 0) {
